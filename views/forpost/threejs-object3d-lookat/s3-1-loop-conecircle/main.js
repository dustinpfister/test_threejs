...
// ---------- ---------- ----------
// ALL LOOK HELPER
const allLook = function(group, target){
...
// [ [[x, y, z], coneLength], ... ]
const coneDataArray = [], len = 8;
let i = 0, x, y, z, radian, radius = 3;
while(i < len){
...
coneDataArray.forEach(function(coneData){
    const cone = new THREE.Mesh( new THREE.ConeGeometry(0.5, coneData[1], 30, 30), coneMaterial);
