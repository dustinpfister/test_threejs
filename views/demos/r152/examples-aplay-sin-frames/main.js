...
// CURVE
// ---------- ----------
const v_start = new THREE.Vector3(-5, -5, 5);
const v_end = new THREE.Vector3(-5, 5, -5);
const v_c1 = v_start.clone().lerp(v_end, 0.25).add( new THREE.Vector3(10, 5, 0) );
const v_c2 = v_start.clone().lerp(v_end, 0.75).add( new THREE.Vector3(10, -5, 0) );
