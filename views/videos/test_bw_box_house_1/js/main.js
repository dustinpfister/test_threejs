(function () {
    ...
    scene.add(camera);
    BetaWorld.positionObject(world, camera, 0.25, 0.5, 20.5);
    ...
    loader.load("/dae/box_house_1/box_house1.dae", function (result) {
        ...
        var house_wrap = BetaWorld.createObjectWrapper(world, group);
        house_wrap.rotateY(1.2);
        BetaWorld.positionObject(world, house_wrap, 0, 0, -1.2);
        scene.add(house_wrap);
